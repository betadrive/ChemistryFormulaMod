...
public class Elements {
    ...
    public static EnumMap<ChemistryElement, Integer> ATOMIC_NUMBERS = new EnumMap<>(ChemistryElement.class) {{
    ...
    public static HashMap<Integer, String> subscripts = new HashMap<>() {{
        put(1, "₁");
        put(2, "₂");
        put(3, "₃");
        put(4, "₄");
